...
Scenario('showing empty liked restaurants', (I) => {
  I.seeElement('#query');
  I.see('Restaurant Not Available', '.restaurantIsEmpty p');
});

Scenario('liking one restuarant', async (I) => {
  I.see('Restaurant Not Available', '.restaurantIsEmpty');
  I.amOnPage('/');
...
Scenario('unliking one restaurant', async (I) => {
  ...
  assert.strictEqual('Restaurant Not Available', FavoriteRestaurantIsEmpty);
});
...
Scenario('Add Review', async (I) => {
  ...
  const textReview = 'Makanannya enak';
  const outputTextReview = 'Makanannya enak';
  I.fillField('input', 'Anto');
