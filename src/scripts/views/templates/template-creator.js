            ...
            <div class="restaurant_img">
                ...
                <picture>
                    ...
                    <img class="lazyload" src="images/placeholder.png"
                        data-src="${restaurant.pictureId ? CONFIG.BASE_IMAGE_URL + large + restaurant.pictureId : 'images/placeholder.png'}" alt="Restoran ${restaurant.name || '-'} Kota ${restaurant.city}">
                </picture>
            </div>
  ...
  for (let i = 0; i < count; i += 1) {
    template += `
        <article class="post-item" >
            <img class="post-item-picture" src="images/placeholder.png" alt="skeleton" width="100%" height="350px">
...
const createSkeletonRestaurantDetail = () => {
  ...
  template += `
        <div class="detail">
            ...
            <div class="restaurant_desc">
                <p class="skeleton">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.</p>
            </div>
        </div>
    `;
  return template;
...
const createRestaurantListTemplate = (restaurant) => `
    <article class="post-item" >
        <p class="post-item-city">Kota. ${restaurant.city || '-'}</p>
        <picture>
            <source class="lazyload" media="(max-width: 600px)" data-srcset="${CONFIG.BASE_IMAGE_URL + small + restaurant.pictureId}">
            <source class="lazyload" media="(max-width: 1200px)" data-srcset="${CONFIG.BASE_IMAGE_URL + medium + restaurant.pictureId}">
            <img class="post-item-picture lazyload" src="images/placeholder.png"
                data-src="${restaurant.pictureId ? CONFIG.BASE_IMAGE_URL + large + restaurant.pictureId : 'images/placeholder.png'}" alt="Restoran ${restaurant.name || '-'} Kota ${restaurant.city}">
        </picture>
        <div class="post-item-content">
            <p class="post-item-rate">Rating : <i class="fa-solid fa-star"></i><span> ${restaurant.rating || '-'}</span></p>
